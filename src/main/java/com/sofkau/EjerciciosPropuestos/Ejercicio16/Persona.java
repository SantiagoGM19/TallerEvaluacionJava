...
public class Persona {
    ...
    public String toString(){
        String infoSexo = sexo=='M'?"mujer":"hombre";
        return "La persona "+nombre+" tiene de DNI "+DNI+", es "+infoSexo+" tiene "+edad.toString()+" años de " +
                "edad, pesa "+peso.toString()+" kilogramos y tiene una altura de "+altura.toString()+" metros";
    }
